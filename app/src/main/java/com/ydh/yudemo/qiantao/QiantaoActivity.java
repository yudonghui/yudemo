...
public class QiantaoActivity extends AppCompatActivity {
    ...
    private void initView() {
        relaTop = (RelativeLayout) findViewById(R.id.rela_top);
        scrollView = (ObservableScrollView) findViewById(R.id.scrollView_main);
        viewPager = (PersonalViewpager) findViewById(R.id.viewpager_main);
        lineTab = (LinearLayout) findViewById(R.id.line_tab);
        lineTab2 = (LinearLayout) findViewById(R.id.line_tab2);
