...
/**
 * Created by Android on 2018/9/7.
 */
...
public class CircleBarView extends View {
    ...
    private float maxNum;//进度条最大值 最大值100
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        barWidth = typedArray.getDimension(R.styleable.CircleBarView_bar_width, DisplayUtil.dip2px(context,10));
        typedArray.recycle();
    ...
    public class CircleBarAnim extends Animation {
        ...
        protected void applyTransformation(float interpolatedTime, Transformation t) {//interpolatedTime从0渐变成1,到1时结束动画,持续时间由setDuration（time）方法设置
            ...
            if(onAnimationListener!=null){
                if(textView !=null){
                    String text = onAnimationListener.howToChangeText(interpolatedTime, progressNum, maxNum);
                    textView.setText((int)(progressSweepAngle*100/sweepAngle)+"%");
                }
