...
import com.ydh.yudemo.permissiontest.permission.RequestExecutor;
import com.ydh.yudemo.permissiontest.permission.YuAlertDialog;
...
public final class DefaultRationale implements Rationale {
    ...
    public void showRationale(Context context, List<String> permissions, final RequestExecutor executor) {
        ...
        YuAlertDialog.newBuilder(context)
                .setCancelable(false)
