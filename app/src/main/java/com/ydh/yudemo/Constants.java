...
public interface Constants {
    ...
    String TONGYONGDAIMA = "tongyongdaima";
    String KUANGJIA = "kuangjia";
    String ZIDINGYIVIEW = "zidingyiview";
    String YINDAOYE = "yindaoye";
    String KETUODONGVIEW = "ketuodongview";
    String ZIDINGYIJIANPAN = "zidingyijianpan";
    String YUANXINGTU = "yuanxingtu";
    String JC = "jc";
    String TUOZHUAIGRID = "tuozhuaigrid";
    String REFRESH = "refresh";
    String LUNBOTU = "lunbotu";
    String WEELVIEW = "weelview";
    String HUALANG = "hualang";
    String STICKY = "sticky";
    String MATCHVIEW = "matchView";
    String PERMISSION = "permission";
    String EXPANDTEXTVIEW = "expandtextview";
    String PACHONG = "pachong";
    String PENGYOUQUAN = "pengyouquan";
    String GONGJULEI = "gongjulei";
    String CELIANGSCROLL = "celiangscroll";
    String JS = "js";
    String ANIMATION = "animation";
    String QIANTAOWENTI = "qiantaowenti";
    String YUANJIAO = "yuanjiao";
    String SHUXINGTU = "shuxingtu";
    String TEST = "test";
