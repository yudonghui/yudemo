...
public class DragGridView extends GridView implements AdapterView.OnItemLongClickListener {
    ...
    private void initWindow() {
        if (dragView == null) {
            ...
            TextView mTitle = (TextView) dragView.findViewById(R.id.text_title);
            TextView mRule = (TextView) dragView.findViewById(R.id.text_rule);
            ImageView mImageView = (ImageView) dragView.findViewById(R.id.image);
            mTitle.setText(((TextView) view.findViewById(R.id.text_title)).getText());
            mRule.setText(((TextView) view.findViewById(R.id.text_rule)).getText());
            mImageView.setImageDrawable(((ImageView) view.findViewById(R.id.image)).getDrawable());
        }
