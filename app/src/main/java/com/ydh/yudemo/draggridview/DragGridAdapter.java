...
public abstract class DragGridAdapter<T> extends BaseAdapter {
    ...
    private OnChanageListener mChangeListener;

    public void setOnChangeListener(OnChanageListener mChangeListener) {
    ...
    public void exchangePosition(int originalPosition, int nowPosition, boolean isMove) {
        ...
        this.isMove = isMove;
        mChangeListener.onChange(originalPosition, nowPosition);
