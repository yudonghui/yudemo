...
public class ChangeDatePopwindow extends PopupWindow implements View.OnClickListener {
    ...
    public ChangeDatePopwindow(final Context context) {
        ...
        View view = View.inflate(context, R.layout.dialog_bill_date, null);
...
//		this.setAnimationStyle(R.style.AnimBottom);
    ...
    public void setDate(String year, String month, String day) {
        ...
        mYearAdapter = new CalendarTextAdapter(context, arry_years, setYear(yearNum + ""), maxTextSize, minTextSize);
        wvYear.setVisibleItems(5);
        wvYear.setViewAdapter(mYearAdapter);
        wvYear.setCurrentItem(setYear(yearNum + ""));

        mMonthAdapter = new CalendarTextAdapter(context, arry_months, monthNum - 1, maxTextSize, minTextSize);
        wvMonth.setVisibleItems(5);
        wvMonth.setViewAdapter(mMonthAdapter);
        wvMonth.setCurrentItem(monthNum - 1);

        mDaydapter = new CalendarTextAdapter(context, arry_days, dayNum - 1, maxTextSize, minTextSize);
        wvDay.setVisibleItems(5);
        wvDay.setViewAdapter(mDaydapter);
        wvDay.setCurrentItem(dayNum - 1);

        selectYear = yearNum + "年";
        selectMonth = monthNum + "月";
        selectDay = dayNum + "日";
        issetdata = true;
